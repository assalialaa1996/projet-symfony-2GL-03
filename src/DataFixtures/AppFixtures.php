...
class AppFixtures extends Fixture
{
    ...
    private function loadPosts(ObjectManager $manager): void
    {
        foreach ($this->getPostData() as [$title, $slug, $summary, $content, $publishedAt, $author, $tags]) {
            ...
            foreach (range(1, 5) as $i) {
                $comment = new Comment();
                $comment->setAuthor($this->getReference('dhia2020'));
    ...
    private function getUserData(): array
    {
        return [
            ...
            ['Alaa Assali', 'alaa2020', '12345678', 'alaa.assali1996@gmail.com', ['ROLE_ADMIN']],
            ['Dhia Dhaouadi', 'dhia2020', '12345678', 'dhia@gmail.com', ['ROLE_ADMIN']]
    ...
    private function getPostData()
    {
        ...
        foreach ($this->getPhrases() as $i => $title) {
            ...
            $posts[] = [
                ...
                $this->getReference(['alaa2020', 'dhia2020'][0 === $i ? 0 : random_int(0, 1)]),
                $this->getRandomTags(),
            ];
        }
